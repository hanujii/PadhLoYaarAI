...
import { ToolErrorBoundary } from '@/components/error-boundary/ToolErrorBoundary';
...
export default function QuestionSolverPage() {
    ...
    return (
        <ToolErrorBoundary toolName="Question Solver">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8 pb-16 sm:pb-20">
                <ToolBackButton />
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="space-y-2">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold">Question Solver</h1>
