...
export class GroqProvider implements AIProvider {
    ...
    getModels(): ModelDTO[] {
        // Groq models
        return [
            { id: 'llama-3.1-8b-instant', name: 'Llama 3.1 8B (Groq)', provider: 'groq', isPro: false, contextWindow: 8192 },
            { id: 'llama-3.3-70b-versatile', name: 'Llama 3.3 70B (Groq)', provider: 'groq', isPro: true, contextWindow: 32768 },
            { id: 'mixtral-8x7b-32768', name: 'Mixtral 8x7B (Groq)', provider: 'groq', isPro: false, contextWindow: 32768 },
            { id: 'gemma2-9b-it', name: 'Gemma 2 9B (Groq)', provider: 'groq', isPro: false, contextWindow: 8192 },
        ];
    }
